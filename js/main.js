...
const DEFAULTS = {
  ...
  ceremonyVenue: 'St. Michael\'s Cathedral',
  ceremonyAddress: '123 Church Lane, New York',
  receptionTime: '7:00 PM',
  receptionVenue: 'The Grand Ballroom',
  receptionAddress: '45 Park Avenue, New York',
  message: 'Together with their families, joyfully request the honor of your presence at their wedding celebration.',
  storyQuote: '"Love is not finding someone to live with; it\'s finding someone you can\'t live without."',
  storyText: 'What started as a chance meeting became a lifelong journey. After years of laughter, adventures, and countless memories, we are ready to take the next step — together, forever.',
  musicUrl: '',
  musicAutoplay: false,
  musicEnabled: true,
  galleryImages: [],
